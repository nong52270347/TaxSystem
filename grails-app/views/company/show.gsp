		...
		<div id="show-company" class="content scaffold-show" role="main">
			...
			<ol class="property-list company">
				...
				<li class="fieldcontain">
					<span id="code-label" class="property-label"><g:message code="company.code.label" default="Code" /></span>
					
						<span class="property-value" aria-labelledby="code-label"><g:fieldValue bean="${companyInstance}" field="code"/></span>
				...
				<g:if test="${companyInstance?.taxId}">
				<li class="fieldcontain">
					<span id="taxId-label" class="property-label"><g:message code="company.taxId.label" default="Tax Id" /></span>
					
						<span class="property-value" aria-labelledby="taxId-label"><g:fieldValue bean="${companyInstance}" field="taxId"/></span>
